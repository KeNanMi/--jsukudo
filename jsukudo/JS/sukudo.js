...
{
	$('#timer').stopTime();
	$('#timer').html('Timer:<span>00:00:00<span/>').find('span').css({'font-weight': '100'});
	InitData();
	CreateSukudoArray();
	InitBlockData(l);
	CreateSukudoTable();
	...
	function(){
		$(this).removeClass('h');
	}).click(function(){$('td').removeClass('sel').unmousewheel();$(this).addClass('sel').mousewheel(function(objEvent, intDelta){wc(intDelta,$(this));});currentmouseint=$(this).num();});$('#lefts').html('LeftSquares:'+blockscount+'');$('#leftsg').refreshnumcount();
